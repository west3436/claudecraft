...
- **Multi-computer messaging** — send messages between computers and turtles for coordinated tasks
...
| Tool | Description |
|---|---|
| `reply` | Send a text response to the player |
| `read_file` | Read contents of a file on the computer |
...
| `send_message` | Send messages to other computers/turtles |
