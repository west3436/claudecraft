...
public class ToolDefinitions {
    ...
    public static final List<String> STANDARD_TOOLS = Collections.unmodifiableList(Arrays.asList(
            "reply",
            "read_file",
            "write_file",
            "edit_file",
    ...
    public static final List<String> TURTLE_TOOLS = Collections.unmodifiableList(Arrays.asList(
            "turtle_move",
            "turtle_dig",
            "turtle_place",
            "turtle_inspect",
    ...
    public static List<String> allToolNames() {
        List<String> all = new ArrayList<>(STANDARD_TOOLS);
